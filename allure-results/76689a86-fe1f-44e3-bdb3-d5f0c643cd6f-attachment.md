...
- Name: ui\category.spec.js >> Category Tabs >> TC-CAT-04: Clicking "Top rated" tab loads content
- Location: tests\ui\category.spec.js:64:3
...
Call log:
  - waiting for locator('header nav ul li a[href="/top-rated"]')
