...
Locator: locator('aside [class*="-placeholder"]').nth(1)
Expected: "Select..."
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('aside [class*="-placeholder"]').nth(1)
...
```ts
  ...
  16  |     const placeholder = homePage.page.locator('aside [class*="-placeholder"]').nth(1);
