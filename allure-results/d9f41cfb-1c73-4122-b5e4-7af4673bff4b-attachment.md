...
- Name: filtering\year.spec.js >> Year Filter >> TC-YR-05: Selecting a year range (2010–2020) returns relevant results
- Location: tests\filtering\year.spec.js:92:3
    ...
    - generic [ref=e22]:
      - generic [ref=e23]:
        - generic [ref=e24]:
          ...
          - paragraph [ref=e26]: "Suspicious Practice Room: Special Treatment of Mother's Friend"
          - paragraph [ref=e27]: Drama, 2018
        - generic [ref=e28]:
          - img "Movie Poster" [ref=e29]
          - paragraph [ref=e30]: An Affair - Two Sisters
          - paragraph [ref=e31]: Drama, 2017
        - generic [ref=e32]:
          - img "Movie Poster" [ref=e33]
          - paragraph [ref=e34]: Triple Crossed
          - paragraph [ref=e35]: Mystery, 2013
        - generic [ref=e36]:
          - img "Movie Poster" [ref=e37]
          - paragraph [ref=e38]: The Story of Ong-nyeo
          - paragraph [ref=e39]: Romance, 2014
        - generic [ref=e40]:
        ...
        - generic [ref=e44]:
          ...
          - paragraph [ref=e46]: Hedon
          - paragraph [ref=e47]: Drama, 2019
        - generic [ref=e48]:
          - img "Movie Poster" [ref=e49]
          - paragraph [ref=e50]: Younger Sister-in-law
          - paragraph [ref=e51]: Romance, 2018
        - generic [ref=e52]:
          - img "Movie Poster" [ref=e53]
          - paragraph [ref=e54]: Underwater
          - paragraph [ref=e55]: Drama, 2016
        - generic [ref=e56]:
          - img "Movie Poster" [ref=e57]
          - paragraph [ref=e58]: The Human Centipede 3 (Final Sequence)
          - paragraph [ref=e59]: Horror, 2015
        - generic [ref=e60]:
          - img "Movie Poster" [ref=e61]
          - paragraph [ref=e62]: Invitation Girl
          - paragraph [ref=e63]: Romance, 2018
        - generic [ref=e64]:
          - img "Movie Poster" [ref=e65]
          - paragraph [ref=e66]: Batman & Robin
          - paragraph [ref=e67]: Action, 1997
        - generic [ref=e68]:
          - img "Movie Poster" [ref=e69]
          - paragraph [ref=e70]: The Human Centipede 2 (Full Sequence)
          - paragraph [ref=e71]: Drama, 2011
        - generic [ref=e72]:
          - img "Movie Poster" [ref=e73]
          - paragraph [ref=e74]: Scary Movie 5
          - paragraph [ref=e75]: Comedy, 2013
        - generic [ref=e76]:
          - img "Movie Poster" [ref=e77]
          - paragraph [ref=e78]: Young Sister-In-Law 2
          - paragraph [ref=e79]: Romance, 2017
        - generic [ref=e80]:
          - img "Movie Poster" [ref=e81]
          - paragraph [ref=e82]: The Last Airbender
          - paragraph [ref=e83]: Action, 2010
        - generic [ref=e84]:
          - img "Movie Poster" [ref=e85]
          - paragraph [ref=e86]: My Mother's Lovers
          - paragraph [ref=e87]: Drama, 2020
        - generic [ref=e88]:
          - img "Movie Poster" [ref=e89]
          - paragraph [ref=e90]: Young Lady
          - paragraph [ref=e91]: Comedy, 2015
        - generic [ref=e92]:
          - img "Movie Poster" [ref=e93]
          - paragraph [ref=e94]: My Neighbor's Wife
          - paragraph [ref=e95]: Romance, 2016
        - generic [ref=e96]:
          - img "Movie Poster" [ref=e97]
          - paragraph [ref=e98]: Movida
          - paragraph [ref=e99]: ", 2020"
        - generic [ref=e100]:
          - img "Movie Poster" [ref=e101]
          - paragraph [ref=e102]: Favorite Concubine
          - paragraph [ref=e103]: Drama, 2020
      - list [ref=e105]:
        - listitem [ref=e106]:
        ...
        - listitem [ref=e116]:
          - button "..." [ref=e117]
        - listitem [ref=e118]:
          - button "Page 10843" [ref=e119]: "10843"
        - listitem [ref=e120]:
          - button "Page 10844" [ref=e121]: "10844"
        - listitem [ref=e122]:
          - button "Page 10845" [ref=e123]: "10845"
        - listitem [ref=e124]:
  ...
  - complementary [ref=e126]:
    ...
    - generic [ref=e128]:
      ...
      - generic [ref=e158]:
        - generic [ref=e161]:
          - generic [ref=e162]:
            - generic [ref=e163]: "2010"
            - textbox [ref=e166]
          - img [ref=e170]
        - generic [ref=e172]: "-"
        - generic [ref=e173]:
          - generic [ref=e174]: option 2020, selected. Select is focused ,type to refine list, press Down to open the menu,
          - generic [ref=e175]:
            - generic [ref=e176]:
              - generic [ref=e177]: "2020"
...
> 113 |     expect(allInRange).toBe(true);
  ...
  116 | 
  117 | 
  118 |   // ── TC-YR-06 (Negative) ────────────────────────────────────────────────────
  119 |   test('TC-YR-06 [NEGATIVE]: Inverted range (From > To) — observe behaviour', async () => {
  120 |     logger.step('Set From year (2024) greater than To year (2000)');
  121 |     await homePage.selectYearFrom(2024);
  122 |     await homePage.selectYearTo(2000);
  123 | 
  124 |     await homePage.page.waitForTimeout(1500);
  125 | 
  126 |     const cardCount = await homePage.getCardCount();
  127 |     const { from, to } = await homePage.getSelectedYears();
  128 |     logger.warn(`[NEGATIVE] From: ${from}, To: ${to} — cards: ${cardCount}`);
  129 | 
  130 |     await homePage.page.screenshot({
  131 |       path: 'test-results/screenshots/tc-yr-06-inverted-range.png',
  132 |     });
  133 |     // Document behaviour; no hard assertion — this is a boundary condition
  134 |   });
  135 | 
  136 |   // ── TC-YR-07 (API) ─────────────────────────────────────────────────────────
  137 |   test('TC-YR-07: Changing year triggers API call with year params', async () => {
  138 |     logger.step('Collect API calls when changing Year From to 2022');
  139 | 
  140 |     const calls = await homePage.collectApiCalls(async () => {
  141 |       await homePage.selectYearFrom(2022);
  142 |     });
  143 | 
  144 |     expect(calls.length).toBeGreaterThan(0);
  145 |     const firstCall = calls[0];
  146 |     logger.info(`API URL: ${firstCall.url.href}`);
  147 | 
  148 |     const params = firstCall.url.searchParams;
  149 |     const hasYearParam =
  150 |       params.has('primary_release_date.gte') ||
  151 |       params.has('first_air_date.gte') ||
  152 |       params.has('year');
  153 | 
  154 |     logger.info(`API has year param: ${hasYearParam}`);
  155 |     logger.info(`All params: ${params.toString()}`);
  156 | 
  157 |     await homePage.page.screenshot({
  158 |       path: 'test-results/screenshots/tc-yr-07-api-year.png',
  159 |     });
  160 |   });
  161 | });
```